...
9. **Internal Shared Memory** — внутренняя SHM между модулями (~100 нс)
10. **Spy Mining** — майнинг до полной валидации блока
11. **P2P/FIBRE Headers Sync** — быстрое получение заголовков через сеть
...
### Автономность
17. **Встроенный Template Generator** — создание шаблонов блоков без внешних зависимостей
